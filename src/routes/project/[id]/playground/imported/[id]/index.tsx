...
import styles from "../../[id]/playground.scss?inline";
...
export default component$(() => {
  ...
  const deploymentResource = useResource$(async () => {
    ...
    const response =
      await LokiProjectDeploymentsService.fetchImportedDeployment(
        projectID,
  ...
  const copyPublicUrl = $(() => {
    ...
    const publicPathName = pathname.replace("/imported", "/imported/public");
